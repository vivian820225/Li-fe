        ...
        <div class="flex-grow lg:w-auto w-full bg-gray-100 rounded-lg mr-8 sm:p-8 p-4">
          ...
          <section>
            <div class="flex justify-between items-end mb-4">
              ...
              <router-link
                to="/products"
                class="font-bold underline text-primary-default hover:text-primary-dark transition"
              >
                繼續購物
              </router-link>
            </div>
        ...
        <div class="lg:w-1/3 w-full bg-gray-100 rounded-lg sm:p-8 p-4">
          <section>
            ...
            <div class="flex mb-8 select-none text-center">
              <label
                for="atm"
                class="inline-block relative py-2 sm:px-4 px-2 font-bold bg-white border-2
                border-primary-default rounded-lg hover:bg-primary-default
              ...
              <label
                for="creditcard"
                class="inline-block relative py-2 px-4 font-bold bg-white border-2
                border-primary-default rounded-lg hover:bg-primary-default
                transition cursor-pointer mr-4"
              >
                <span>信用卡付款</span>
